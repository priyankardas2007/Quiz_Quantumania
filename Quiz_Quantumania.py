...
class UserForm(ctk.CTkFrame):
    ...
    def get_username(self): 
         ...
         #👉 Example: if user typed "Priyankar", this returns "Priyankar".
...
questions=[
    ...
    },
    {
        ...
        "options": ["Cauchy–Schwarz", "Bolzano–Weierstrass", "Banach fixed point", "Hahn–Banach"],
        "answer": "Bolzano–Weierstrass"
    },
    {
    ...
    },
    {
        ...
        "options": ["Fermi–Dirac", "Bose–Einstein", "Maxwell–Boltzmann", "Poisson"],
        "answer": "Bose–Einstein"
    },
    {
...
def start_quiz():
    ...
    def check(selected, answer):
        global score 
        if selected == answer:
         result_label=ctk.CTkLabel(f1, text=" ✅Correct!")
         color="green"
         score +=4 
         ...
         result_label=ctk.CTkLabel(f1, text=" ❌Incorrect! The correct answer is: " + answer) 
         color= "red"
         score-= 1
         result_label.configure(text_color=color, font=("Century Gothic", 18, "bold"))
         result_label.pack(pady=20) 
